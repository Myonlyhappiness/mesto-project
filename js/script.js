...
function popups(event){
  if (event.target.classList.contains('popup__close-button') && popupEdit.classList.contains('popup_opened') || popupAddCard.classList.contains('popup_opened') || popup.classList.contains('popup_img-opened')){
...
popupCloseButtons.forEach(element => element.addEventListener('click', popups));
